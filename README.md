...
<p align="center">
  <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&size=26&duration=3500&pause=1000&color=0EA5E9&center=true&vCenter=true&width=900&lines=Software+Engineer+Building+For+Scale;Cloud+Solutions+That+Solve+Real+Problems;Backend+Systems+Built+For+Performance;Automating+Infrastructure+With+DevOps;Creating+AI-Driven+Applications" alt="Typing SVG" />
</p>
...
**AWS Services:** `EC2` • `S3` • `Lambda` • `API Gateway` • `VPC` • `IAM` • `CloudWatch` • `Auto Scaling` • `AWS SAM`
...
**APIs & Integrations:** `REST APIs` • `Zoom API` • `Paystack` • `Moodle LMS`
...
**Skills:** `Prompt Engineering` • `LLMs` • `AI Application Integration` • `Workflow Automation`
...
**Hosting & Management:** `VPS Hosting` • `cPanel` • `hPanel`
